package cl.sii.cts2.data.export.service;

import cl.sii.cts2.data.export.entities.cts.Cts2Cache;
import cl.sii.cts2.data.export.repository.cts.Cts2CacheRepository;
import cl.sii.cts2.data.export.repository.cts.Cts2DPRepository;
import cl.sii.cts2.data.export.service.exportDB.CRSOECD1_Export;
import cl.sii.cts2.data.export.service.exportDB.CRSOECD2_Export;
import cl.sii.cts2.data.export.service.exportDB.CrsExportService;
import cl.sii.cts2.data.export.util.PackageZipHandler;
   ...
   String getContextPath(Document document, String type){
       ...
       if(type.equals("CRS")){
           ...
           if(element.contains("v1")){
               outContextPath="cl.sii.cts2.data.export.domain.crs.v1.oecd.ties.crs.v1";
           }else{
               outContextPath="cl.sii.cts2.data.export.domain.crs.v2.oecd.ties.crs.v2";
           }
           ...
           if(element.contains("v1")){
               outContextPath="cl.sii.cts2.data.export.domain.cbc.v1.oecd.ties.cbc.v1";
           }else{
               outContextPath="cl.sii.cts2.data.export.domain.cbc.v2.oecd.ties.cbc.v2";
           }
